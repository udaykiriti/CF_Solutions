...
#define scll(x) ll x; cin >> x
#define sc2i(x, y) int x, y; cin >> x >> y
#define sc2ll(x, y) ll x, y; cin >> x >> y
#define sc3i(x, y, z) int x, y, z; cin >> x >> y >> z
#define sc3ll(x, y, z) ll x, y, z; cin >> x >> y >> z
